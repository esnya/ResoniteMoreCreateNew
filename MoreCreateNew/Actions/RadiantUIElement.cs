...
internal sealed class RadiantUIElement : ISpawn
{
    ...
    public void Spawn(Slot slot)
    {
        ...
        else
        {
            ...
            SpriteProvider spriteProvider = slot.AttachSprite(OfficialAssets.Graphics.UI.Circle.Light_Border.Circle_Phi2);
            spriteProvider.Borders.Value = float4.One * 0.5f;
            spriteProvider.FixedSize.Value = RadiantUI_Panel.BAR_SIZE;

            var panel = uiBuilder.Panel(RadiantUI_Constants.BG_COLOR, spriteProvider, uiBuilder.Style.NineSliceSizing, true);
    ...
    private static void HeaderFooter(UIBuilder uiBuilder, string label, Func<(RectTransform, RectTransform)> action)
    {
    ...
    internal static readonly RadiantUIElement[] Actions = new RadiantUIElement[]
    {
        ...
        new ("Checkbox R", hori512, (UIBuilder uiBuilder, string label) => uiBuilder.Checkbox(label, false, true, 4)),
        new ("Checkbox L", hori512, (UIBuilder uiBuilder, string label) => uiBuilder.Checkbox(label, false, false, 4)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.FitContent()),
        new (hori512, (UIBuilder uiBuilder, string label) => uiBuilder.FloatField(float.MinValue, float.MaxValue, 2, null!, true)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.Gradient(RadiantUI_Constants.Hero.RED, RadiantUI_Constants.Hero.GREEN, RadiantUI_Constants.Hero.CYAN, RadiantUI_Constants.Hero.PURPLE)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.GridLayout()),
        new (sq512, (UIBuilder uiBuilder, string label) => HorizontalHeader(uiBuilder, label, RadiantUI_Constants.GRID_CELL_SIZE)),
        new (sq512, (UIBuilder uiBuilder, string label) => HorizontalFooter(uiBuilder, label, RadiantUI_Constants.GRID_CELL_SIZE)),
        new (hori512, (UIBuilder uiBuilder, string label) => uiBuilder.HorizontalElementWithLabel(label, RadiantUI_Constants.GRID_PADDING, () => uiBuilder.Text(label, true, null, true, null!), 0.01f)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.HorizontalGradient(RadiantUI_Constants.Hero.RED, RadiantUI_Constants.Hero.GREEN)),
        ...
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.Image(RadiantUI_Constants.GetLineGridCellTransparentSprite(uiBuilder.World), true)),
        new (hori512, (UIBuilder uiBuilder, string label) => uiBuilder.IntegerField(int.MinValue, int.MaxValue, 1, true)),
        ...
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.RawImage(RadiantUI_Constants.GetLineGridCellTransparentTexture(uiBuilder.World), true)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.RectMesh<AudioSourceWaveformMesh>(null!)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.RectMesh<AudioSourceXYMesh>(null!)),
        ...
        new ("Slider<int>", hori512, (UIBuilder uiBuilder, string label) => uiBuilder.Slider(RadiantUI_Constants.GRID_CELL_SIZE)),
        new ("Slider<float>", hori512, (UIBuilder uiBuilder, string label) => uiBuilder.Slider<float>(RadiantUI_Constants.GRID_CELL_SIZE)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.Spacer(1)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.SpriteMask(RadiantUI_Constants.GetOutlinedSprite(uiBuilder.World), true)),
        new (hori512, (UIBuilder uiBuilder, string label) => uiBuilder.Text(label, true, null, true, null!)),
        new (hori512, (UIBuilder uiBuilder, string label) => uiBuilder.TextField("", false, null!, true, default)),
        new (sq512, (UIBuilder uiBuilder, string label) => VerticalHeader(uiBuilder, label, RadiantUI_Constants.GRID_CELL_SIZE)),
        new (sq512, (UIBuilder uiBuilder, string label) => VerticalFooter(uiBuilder, label, RadiantUI_Constants.GRID_CELL_SIZE)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.VerticalGradient(RadiantUI_Constants.Hero.RED, RadiantUI_Constants.Hero.GREEN)),
        new (sq512, (UIBuilder uiBuilder, string label) => uiBuilder.VerticalLayout(0, 0, null, null, null)),
    };
}
